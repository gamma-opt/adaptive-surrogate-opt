...
% Problem set-up
addpath('./ThermoacousticPredictions/SolverFunctions/')    % Add solver location
...
combined_data = [G, phi, R_in, R_out, alpha, training_Y];
...
% writematrix(combined_data, './ThermoacousticPredictions/data_init.csv')